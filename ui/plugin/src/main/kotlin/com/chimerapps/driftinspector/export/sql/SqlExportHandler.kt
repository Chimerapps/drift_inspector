package com.chimerapps.driftinspector.export.sql
...
class SqlExportHandler(file: File) {
    ...
    fun handle(exportResponse: ExportResponse, database: DriftInspectorDatabase) {
    ...
    private fun getSqlType(table: String, database: DriftInspectorDatabase, key: String): Int {

...
import com.chimerapps.moorinspector.ui.actions.NewSessionAction
...
class InspectorToolWindow(private val project: Project, private val disposable: Disposable) :
    ...
    init {
        ...
        tabsContainer = RunnerLayoutUi.Factory.getInstance(project)
            .create("moor-inspector-ui", "Detail tabs", "Some session name?", disposable)
    ...
    private fun setupViewActions(): ActionToolbar {
        ...
        val toolbar = ActionManager.getInstance().createActionToolbar("Moor Inspector", actionGroup, false)
